...
import com.sopt.Server.controller.request.AnswerListResponseDTO;
import com.sopt.Server.controller.request.AnswerResposneDTO;
...
public class ResultService {
    ...
    @Transactional
    public ResultResponseDTO getResult(AnswerListResponseDTO request) {
        ...
        for(AnswerResposneDTO result : request.results()){
